...
class ShipmentTypeController extends Controller
{
    public function index(Request $request)
    {
        ...
        $datas = FilterController::searchs(new Request($request), $model, ['id', 'code'], false, $associated)->map(function ($shipment) {
    ...
    public function create(Request $request)
    {
        ...
        if (isset($request['orders']['inactive'])) {
            ...
            $datas = FilterController::searchs(new Request($request), $model, ['id', 'code'], false, [])->map(function ($data) {
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (isset($request['orders']['active'])) {
            ...
            $datas = FilterController::searchs(new Request($request['orders']['active']), $model, ['id', 'code'], false, [])->map(function ($data) {
            ...
            $data['orders']['active'] =  HelperFunctions::getPagination($datas, $filters['pagination']['per_page'], $filters['pagination']['current_page']);
        }
        if (isset($request['orders']['inactive'])) {
            $datas = [];
            $model = 'App\\Models\\Order';
