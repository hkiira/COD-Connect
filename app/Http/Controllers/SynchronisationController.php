...
class SynchronisationController extends Controller
{
    ...
    public function syncOrders(){
        ...
        $orders = Order::where('account_id', getAccountUser()->account_id)->whereIn('pickup_id', $pickups)->whereNotNull('pickup_id')->whereNull('shipping_code')->whereNotIn('order_status_id', [6,7])->limit(1000)->get();
        $updatedCode=0;
    ...
    public function syncStatuses()
    {
        ...
        $orders = Order::where('account_id', getAccountUser()->account_id)->whereIn('pickup_id', $pickups)->whereNull('shipment_id')->whereIn('order_status_id', [6,9])->orderByDesc('created_at')->get();
